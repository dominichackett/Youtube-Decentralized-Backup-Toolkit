...
export default function Videos() {
 ...
 const handleClickVideo = (video:any,channel:any) =>{
    ...
    router.push({pathname:"/video" ,query:{id:video.id,thumbnail:channel.thumbnail,channel:channel.id,channelTitle:channel.title,title:video.title,ipfsCID:video.ipfsCID,channelId:video.channel,banner:channel.banner,videoThumbnail:video.thumbnail}})
    ...
    <header>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Videos</h1>
      </div>
