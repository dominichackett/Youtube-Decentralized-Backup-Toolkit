...
const user = {
  ...
  email: 'dominichackett@gmail.com',
  imageUrl:
...
export default function Header() {
    ...
    const [{ space }, { loadAgent,resetAgent, unloadAgent }] = useKeyring()
 
 const handleMenu = async (option)=>{
   if(option == "Sign out"){
  //  alert(JSON.stringify(space.name()))
                  ...
                  <div className="flex">
                    <div className="flex flex-shrink-0 items-center">
                      <img
                        ...
                        src="/mark.svg?color=red&shade=600"
                        alt="Your Company"  crossorigin="anonymous"
                      />
                      <img
                    ...
                    <Menu as="div" className="relative ml-3">
                      <div>
                        <Menu.Button className="flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                          ...
                          <img className="h-8 w-8 rounded-full" src={user.imageUrl} alt="" crossorigin="anonymous"/>
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
                ...
                <div className="border-t border-gray-200 pt-4 pb-3">
                  <div className="flex items-center px-4">
                    <div className="flex-shrink-0">
                      <img className="h-10 w-10 rounded-full" src={user.imageUrl} alt="" crossorigin="anonymous"/>
                    </div>
                    <div className="ml-3">
